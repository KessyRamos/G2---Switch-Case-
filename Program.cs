    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            switch(idade)
            {
                ...
                //Pergunta 4--------------------------------------------------------------------------
                    WriteLine("4)Uma das regras fundamentais para fazer a sinalização do acidente é: ");
                    WriteLine("A) Sinalizar o local até a uma distância a 3 metros do acidente.");
                    WriteLine("B) Iniciar a sinalização após o acidente ser visível.");
                    WriteLine("C) Não sinalizar com materiais encontrados nas imediações tais com galhos de árvores e latas.");
